...
function NodeMenu({
    ...
    const { hovering, idleActions, onHoverActions, selectNodePositionAction } = useWrapNodeMenuFunctions(functions, closeNodeMenu, setMenuMode);
    ...
    return (
        <Animated.View
            ...
            <Animated.View
                ...
                <DirectionMenu
                    action={menuMode === "NORMAL" ? idleActions : selectNodePositionAction}
